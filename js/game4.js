...
const itemNav = document.querySelector(".fruta");
...
const sons = {
    ...
    'banana': 'banana.mp3',
    'cereja': 'cherry.mp3',
    'pitaya': 'dragonfruit.mp3',
    'uva': 'grape.mp3',
    'limao': 'lemon.mp3',
    'laranja': 'orange.mp3',
    'abacaxi': 'pineapple.mp3',
    'morango': 'strawberry.mp3',
    'melancia': 'watermelon.mp3',
 };
...
const playSound = (bicho) => {
    const audio = new Audio(`../audios/frutas/${sons[bicho]}`);
    audio.play();
}
...
function checkEndGame() {
    ...
    if (disabledCards.length == 20) {
      ...
      localStorage.setItem("game-fruta", "won");
...
function restartGame() {
    ...
    localStorage.removeItem("game-fruta");
