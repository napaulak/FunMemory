...
const itemNav = document.querySelector(".brinquedo");
...
const sons = {
  ...
  pipa: "kite.mp3",
  quebra: "pluzze.mp3",
  peteca: "shuttlecock.mp3",
  skate: "skateboard.mp3",
  urso: "teddybear.mp3",
...
const playSound = (bicho) => {
  const audio = new Audio(`../audios/brinquedos/${sons[bicho]}`);
  audio.play();
};
...
function restartGame() {
  ...
  localStorage.removeItem("game-brinquedo");
